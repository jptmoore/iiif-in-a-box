...
- `nginx/maintenance.conf` - Nginx configuration for maintenance mode
- `../web/maintenance.html` - The maintenance page shown to users

## Customization

### Customize the Maintenance Page

Edit [web/maintenance.html](../web/maintenance.html) to customize:
- Message to users
- Estimated downtime
- Contact information
